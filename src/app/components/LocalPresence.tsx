...
export default function LocalPresence() {
  return (
    <section aria-labelledby="campinas-title" className="local-presence grid grid-cols-1 lg:grid-cols-12 gap-8 border-t pt-10 md:pt-16" style={{ borderColor: 'var(--border)' }}>
      <div className="lg:col-span-4">
        <div className="inline-flex items-center gap-2 font-sans text-xs uppercase tracking-widest text-[var(--color-terracotta)]">
          <MapPin size={15} aria-hidden="true" />
          Campinas e região
        </div>
      </div>
      <div className="lg:col-span-8 space-y-6">
        <h2 id="campinas-title" className="section-title max-w-3xl">
