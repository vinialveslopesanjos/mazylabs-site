  ...
  return (
    <section className="space-y-8">
      <div className="flex flex-col items-center text-center space-y-4">
        ...
        <h3 className="text-2xl md:text-3xl font-bold">Estética de Código</h3>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
        ...
        <div className="aspect-[1.58] rounded-xl shadow-2xl bg-[#1c1917] p-1 border border-white/10">
          <div className="h-full w-full rounded-lg bg-black/50 p-3 md:p-6 flex flex-col overflow-hidden">
            <div className="flex items-center gap-2 md:gap-3 mb-3 md:mb-6 border-b border-white/10 pb-3 md:pb-4 shrink-0">
              <MazyLogo color="#c15f3c" className="w-4 h-4 md:w-6 md:h-6 shrink-0" />
              <span className="text-white font-mono text-[10px] md:text-xs">MazyConsole v1.0</span>
            </div>
            <div className="flex-1 font-mono text-[9px] md:text-[10px] text-gray-400 space-y-1 md:space-y-2 overflow-hidden">
              <p className="truncate"><span className="text-[#c15f3c]">root@mazy:~$</span> initiate_sequence --target=optimization</p>
              <p className="text-white">[OK] Loading neural weights...</p>
              <p className="text-white">[OK] Connecting to Data Lake...</p>
              <p className="text-white">[OK] ROI Analysis complete.</p>
              <div className="mt-2 md:mt-4 p-2 md:p-3 bg-[#c15f3c]/10 border-l-2 border-[#c15f3c] text-[#c15f3c]">
                Insight found: Cost reduction (23%).
              </div>
            </div>
          </div>
        </div>
